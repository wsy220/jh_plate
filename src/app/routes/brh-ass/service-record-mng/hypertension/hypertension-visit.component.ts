...
@Component({
  selector: 'hypertension-visit-visit',
  templateUrl: './hypertension-visit.component.html',
})
export class HypertensionVisitComponent implements OnInit {
  ...
  save() {
    this.i.zongfen = this.i.jincan + this.i.shuxi + this.i.chuanyi + this.i.ruce + this.i.huodong;
    let dataPkg = {
      userId: this.userId,
